...
#define CMD "mex_aabb( 'new', [, args] ): "
  ...
  acme::aabb *ptr = new acme::aabb(acme::point(x1, y1, z1), acme::point(x2, y2, z2), 0, 0);
...
#define CMD "mex_aabb( 'getMinX', OBJ ): "
  ...
  acme::aabb *self = DATA_GET(arg_in_1);
  setScalarValue(arg_out_0, self->minX());
#undef CMD
}
...
#define CMD "mex_aabb( 'getMinY', OBJ ): "
  ...
  acme::aabb *self = DATA_GET(arg_in_1);
  setScalarValue(arg_out_0, self->minY());
#undef CMD
}
...
#define CMD "mex_aabb( 'getMinZ', OBJ ): "
  ...
  acme::aabb *self = DATA_GET(arg_in_1);
  setScalarValue(arg_out_0, self->minZ());
#undef CMD
}
...
#define CMD "mex_aabb( 'getMaxX', OBJ ): "
  ...
  acme::aabb *self = DATA_GET(arg_in_1);
  setScalarValue(arg_out_0, self->maxX());
#undef CMD
}
...
#define CMD "mex_aabb( 'getMaxY', OBJ ): "
  ...
  acme::aabb *self = DATA_GET(arg_in_1);
  setScalarValue(arg_out_0, self->maxY());
#undef CMD
}
...
#define CMD "mex_aabb( 'getMaxZ', OBJ ): "
  ...
  acme::aabb *self = DATA_GET(arg_in_1);
  setScalarValue(arg_out_0, self->maxZ());
#undef CMD
}
...
#define CMD "mex_aabb( 'setMinX', OBJ ): "
  ...
  acme::aabb *self = DATA_GET(arg_in_1);
  real other = getScalarValue(arg_in_2, CMD "Error in reading input value");
  self->minX(other);
  self->updateMaxMin();
#undef CMD
}
