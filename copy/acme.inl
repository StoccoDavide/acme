...
namespace acme
{
                       ...
                       const T &px, const T &py)
  {
    ...
    if (is_equal(result, T(0.0)))
      return Cocircular;
    else if (result > T(0.0))
      return PointInside;
    else
      return PointOutside;
  }
  ...
  inline bool intersect(const segment<T, 3> &segment, const box<T, 3> &box)
  {
    ...
    if (abs(my * dz - mz * dy) > (ey * adz + ez * ady))
      return false;
    if (abs(mz * dx - mx * dz) > (ex * adz + ez * adx))
      return false;
    if (abs(mx * dy - my * dx) > (ex * ady + ey * adx))
      return false;
  ...
  template <typename T>
  inline bool intersect(const line<T, 3> &line, const plane<T, 3> &plane)
  {
  ...
  {
    if ((angle >= T(0.0)) && (angle < T(90.0)))
      return 1;
    else if ((angle >= T(90.0)) && (angle < T(180.0)))
      return 2;
    else if ((angle >= T(180.0)) && (angle < T(270.0)))
      return 3;
    else if ((angle >= T(270.0)) && (angle < T(360.0)))
      return 4;
    else if (angle == T(360.0))
      return 1;
    else
      return 0;
  }
  ...
  {
    if ((x > T(0.0)) && (y > T(0.0)))
      return T(atan(y / x) * _180DivPI);
    else if ((x < T(0.0)) && (y > T(0.0)))
      return T(atan(-x / y) * _180DivPI) + T(90.0);
    else if ((x < T(0.0)) && (y < T(0.0)))
      return T(atan(y / x) * _180DivPI) + T(180.0);
    else if ((x > T(0.0)) && (y < T(0.0)))
      return T(atan(-x / y) * _180DivPI) + T(270.0);
    else if ((x == T(0.0)) && (y > T(0.0)))
      return T(90.0);
    else if ((x < T(0.0)) && (y == T(0.0)))
      return T(180.0);
  ...
  inline T robust_cartesian_angle(const T &x, const T &y)
  {
    if ((x > T(0.0)) && (y > T(0.0)))
      ...
      return T(atan(-x / y) * _180DivPI) + T(270.0);
    else if (is_equal(x, T(0.0)) && (y > T(0.0)))
      return T(90.0);
    else if ((x < T(0.0)) && is_equal(y, T(0.0)))
      return T(180.0);
    else if (is_equal(x, T(0.0)) && (y < T(0.0)))
      return T(270.0);
    else
                       ...
                       const T &epsilon)
  {
    ...
    if (not_equal((dy1 * dx2), (dy2 * dx1), epsilon))
      return false;
    if (not_equal((dz1 * dy2), (dz2 * dy1), epsilon))
      return false;
    if (not_equal((dx1 * dz2), (dx2 * dz1), epsilon))
      return false;
  ...
  inline segment<T, D> edge(const triangle<T, D> &triangle, const std::size_t &edge_index)
  {
    switch (edge_index)
    {
    case 0:
      return make_segment(triangle[0], triangle[1]);
    case 1:
      return make_segment(triangle[1], triangle[2]);
    case 2:
      return make_segment(triangle[2], triangle[0]);
    default:
  ...
  inline segment<T, 2> edge(const quadix<T, 2> &quadix, const std::size_t &edge_index)
  {
    ...
    {
    case 0:
      return make_segment(quadix[0], quadix[1]);
    case 1:
      return make_segment(quadix[1], quadix[2]);
    case 2:
      return make_segment(quadix[2], quadix[3]);
    case 3:
      return make_segment(quadix[3], quadix[0]);
    default:
      return degenerate_segment2d<T>();
    }
  }
  ...
  inline segment<T, 2> edge(const rectangle<T> &rectangle, const std::size_t &edge_index)
  {
    ...
    {
    case 0:
      return make_segment(rectangle[0].x, rectangle[0].y, rectangle[1].x, rectangle[0].y);
    case 1:
      return make_segment(rectangle[1].x, rectangle[0].y, rectangle[1].x, rectangle[1].y);
    case 2:
      return make_segment(rectangle[1].x, rectangle[1].y, rectangle[0].x, rectangle[1].y);
    case 3:
      return make_segment(rectangle[0].x, rectangle[1].y, rectangle[0].x, rectangle[0].y);
    default:
      return degenerate_segment2d<T>();
    }
  }
  ...
  inline segment<T, 2> edge(const polygon<T, 2> &polygon, const std::size_t &edge_index)
  {
    if (edge_index >= polygon.size())
      return make_segment(T(0.0), T(0.0), T(0.0), T(0.0));
  ...
  inline segment<T, 2> opposing_edge(const triangle<T, 2> &triangle, const std::size_t &corner)
  {
    ...
    {
    case 0:
      return edge(triangle, 1);
    case 1:
      return edge(triangle, 2);
    case 2:
      return edge(triangle, 0);
    default:
      return degenerate_segment2d<T>();
    }
  }
  ...
  inline point2d<T> rectangle_corner(const rectangle<T> &rectangle, const std::size_t &corner_index)
  {
    ...
    case 0:
      return rectangle[0];
    case 1:
      return make_point(rectangle[1].x, rectangle[0].y);
    case 2:
      return make_point(rectangle[1].x, rectangle[1].y);
    case 3:
      return make_point(rectangle[0].x, rectangle[1].y);
    default:
      return degenerate_point2d<T>();
    }
  }
  ...
  inline point3d<T> box_corner(const box<T, 3> &box, const std::size_t &corner_index)
  {
    ...
    case 0:
      return box[0];
    case 1:
      return make_point(box[1].x, box[0].y, box[0].z);
    case 2:
      return make_point(box[1].x, box[1].y, box[0].z);
    case 3:
      return make_point(box[0].x, box[1].y, box[0].z);
    case 4:
      return box[1];
    case 5:
      return make_point(box[1].x, box[0].y, box[1].z);
    case 6:
      return make_point(box[1].x, box[1].y, box[1].z);
    case 7:
      return make_point(box[0].x, box[1].y, box[1].z);
    default:
      return degenerate_point3d<T>();
    }
  }
  ...
  inline line<T, 2> triangle_bisector(const triangle<T, 2> &triangle, const std::size_t &bisector)
  {
    ...
    {
    case 0:
      return create_line_from_bisector(triangle[2], triangle[0], triangle[1]);
    case 1:
      return create_line_from_bisector(triangle[0], triangle[1], triangle[2]);
    case 2:
      return create_line_from_bisector(triangle[0], triangle[2], triangle[1]);
    default:
  ...
  inline line<T, 2> triangle_median(const triangle<T, 2> &triangle, const std::size_t &median)
  {
    ...
    {
    case 0:
      return make_line(triangle[0], segment_mid_point(triangle[1], triangle[2]));
    case 1:
      return make_line(triangle[1], segment_mid_point(triangle[0], triangle[2]));
    case 2:
      return make_line(triangle[2], segment_mid_point(triangle[0], triangle[1]));
    default:
      return degenerate_line2d<T>();
    }
  }
  ...
  inline line<T, 2> confined_triangle_median(const triangle<T, 2> &triangle, const point2d<T> &point, const std::size_t &median)
  {
    ...
    {
    case 0:
      return make_line(triangle[0], intersection_point(edge(triangle, 1), make_line(triangle[0], point)));
    case 1:
      return make_line(triangle[1], intersection_point(edge(triangle, 2), make_line(triangle[1], point)));
    case 2:
      return make_line(triangle[2], intersection_point(edge(triangle, 0), make_line(triangle[2], point)));
    default:
      return degenerate_line2d<T>();
    }
  }
  ...
  template <typename T>
  inline void create_right_triangle(const acme::point2d<T> &p1, const acme::point2d<T> &p2,
                                               ...
                                               std::vector<segment<T, 2>> &segments)
  {
    ...
    case 1:
      segments.push_back(make_segment(lines[0]));
      return;
  ...
  inline bool convex_quadix(const quadix<T, 2> &quadix)
  {
    ...
    if (orin != orientation(quadix[1], quadix[3], quadix[2]))
      return false;
    if (orin != orientation(quadix[2], quadix[0], quadix[3]))
      return false;
    if (orin != orientation(quadix[3], quadix[1], quadix[0]))
      return false;
  ...
  template <typename T>
  inline bool is_right_triangle(const acme::triangle<T, 2> &triangle)
  {
  ...
  template <typename T>
  inline bool is_right_triangle(const acme::triangle<T, 3> &triangle)
  {
    const T a = acme::lay_distance(acme::edge(triangle, 0));
    const T b = acme::lay_distance(acme::edge(triangle, 1));
    const T c = acme::lay_distance(acme::edge(triangle, 2));
  ...
  template <typename T>
  inline line<T, 2> mirror(const line<T, 2> &line, const acme::line<T, 2> &mirror_axis)
  {
    acme::line<T, 2> line_;
  ...
  template <typename T>
  inline line<T, 3> mirror(const line<T, 3> &line, const acme::line<T, 3> &mirror_axis)
  {
    acme::line<T, 3> line_;
  ...
  inline polygon<T, 2> minkowski_sum(const triangle<T, 2> &triangle1, const triangle<T, 2> &triangle2)
  {
    ...
    for (std::size_t i = 0; i < acme::triangle<T, 2>::PointCount; ++i)
    {
      for (std::size_t j = 0; j < acme::triangle<T, 2>::PointCount; ++j)
      {
  ...
  inline polygon<T, 2> minkowski_sum(const quadix<T, 2> &quadix1, const quadix<T, 2> &quadix2)
  {
    ...
    for (std::size_t i = 0; i < acme::quadix<T, 2>::PointCount; ++i)
    {
      for (std::size_t j = 0; j < acme::quadix<T, 2>::PointCount; ++j)
      {
  ...
  {
    acme::polygon<T, 2> polygon;
    acme::polygon<T, 2> circle_polygon = make_polygon(circle);
  ...
  {
    int result = 0;
    if (point.y < rectangle[0].y)
      result |= CLIP_TOP;
    else if (point.y > rectangle[1].y)
      result |= CLIP_BOTTOM;

    if (point.x < rectangle[0].x)
      result |= CLIP_LEFT;
    else if (point.x > rectangle[1].x)
      result |= CLIP_RIGHT;
  ...
  {
    if (!intersect(src_segment, triangle))
      return false;
    ...
    if (intersect(src_segment, edge(triangle, 0), csegment[pos].x, csegment[pos].y))
      pos++;

    if (intersect(src_segment, edge(triangle, 1), csegment[pos].x, csegment[pos].y))
      pos++;

    if ((pos < 2) && intersect(src_segment, edge(triangle, 2), csegment[pos].x, csegment[pos].y))
      pos++;
  ...
  {
    if (!intersect(src_segment, quadix))
      return false;
    ...
    if (intersect(src_segment, edge(quadix, 0), csegment[pos].x, csegment[pos].y))
      pos++;
    if (intersect(src_segment, edge(quadix, 1), csegment[pos].x, csegment[pos].y))
      pos++;

    if ((pos < 2) && (intersect(src_segment, edge(quadix, 2), csegment[pos].x, csegment[pos].y)))
      pos++;
    if ((pos < 2) && (intersect(src_segment, edge(quadix, 3), csegment[pos].x, csegment[pos].y)))
      pos++;
  ...
  {
    return T(0.5) * ((point1.x * (point2.y - point3.y)) +
  ...
  {
    return T(0.5) * ((triangle[0].x * (triangle[1].y - triangle[2].y)) +
  ...
  {
    return T(0.5) * ((quadix[0].x * (quadix[1].y - quadix[3].y)) +
  ...
  {
    if (polygon.size() < 3)
      return make_rectangle(T(0.0), T(0.0), T(0.0), T(0.0));
  ...
  inline triangle<T, 2> right_shift(const triangle<T, 2> &triangle, const std::size_t &shift)
  {
    ...
    case 0:
      return triangle;
    case 1:
      return make_triangle(triangle[2], triangle[0], triangle[1]);
    case 2:
      return make_triangle(triangle[1], triangle[2], triangle[0]);
    default:
      return triangle;
    }
  }
  ...
  inline quadix<T, 2> right_shift(const quadix<T, 2> &quadix, const std::size_t &shift)
  {
    ...
    case 0:
      return quadix;
    case 1:
      return make_quadix(quadix[3], quadix[0], quadix[1], quadix[2]);
    case 2:
      return make_quadix(quadix[2], quadix[3], quadix[0], quadix[1]);
    case 3:
      return make_quadix(quadix[1], quadix[2], quadix[3], quadix[0]);
    default:
      return quadix;
    }
  }
  ...
  inline rectangle<T> make_rectangle(const T &x1, const T &y1, const T &x2, const T &y2)
  {
    ...
    if (rectangle_[1].x < rectangle_[0].x)
      std::swap(rectangle_[0].x, rectangle_[1].x);
    if (rectangle_[1].y < rectangle_[0].y)
      std::swap(rectangle_[0].y, rectangle_[1].y);
  ...
  inline box<T, 3> make_box(const T &x1, const T &y1, const T &z1, const T &x2, const T &y2, const T &z2)
  {
    ...
    if (box_[1].x < box_[0].x)
      std::swap(box_[0].x, box_[1].x);
    if (box_[1].y < box_[0].y)
      std::swap(box_[0].y, box_[1].y);
    if (box_[1].z < box_[0].z)
      std::swap(box_[0].z, box_[1].z);
  ...
  inline polygon<T, 2> make_polygon(const triangle<T, 2> &triangle)
  {
    ...
    polygon_.reserve(acme::triangle<T, 2>::PointCount);
  ...
  inline polygon<T, 2> make_polygon(const quadix<T, 2> &quadix)
  {
    ...
    polygon_.reserve(acme::quadix<T, 2>::PointCount);
