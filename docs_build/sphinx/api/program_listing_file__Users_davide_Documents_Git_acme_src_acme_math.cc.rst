...
.. _program_listing_file__Users_davide_Documents_Git_acme_src_acme_math.cc:

Program Listing for File acme_math.cc
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file__Users_davide_Documents_Git_acme_src_acme_math.cc>` (``/Users/davide/Documents/Git/acme/src/acme_math.cc``)
