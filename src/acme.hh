...
namespace acme
{
  ...
  {
  public:
    typedef pointnd<T, Dimension> PointType;
  };
  ...
  /************[  CircularArc Type   ]**************/
  template <typename T>
  class circular_arc : public entity
  {
  public:
    T x1, y1;
    T x2, y2;
  ...
  {
  public:
    typedef vectornd<T, Dimension> VectorType;
  };
  ...
  template <typename T>
  inline bool cocircular(const triangle<T, 2> &triangle,
                         const point2d<T> &point,
                         const T &epsilon = T(Epsilon));

  template <typename T>
  inline bool cocircular(const circle<T> &circle,
                         const point2d<T> &point,
                         const T &epsilon = T(Epsilon));
  ...
  template <typename T>
  inline bool intersect(const segment<T, 3> &segment1, const segment<T, 3> &segment2, const T &fuzzy = T(0.0));
  template <typename T>
  ...
  template <typename T>
  inline bool intersect(const segment<T, 3> &segment, const line<T, 3> &line, const T &fuzzy = T(0.0));
  template <typename T>
  ...
  template <typename T>
  inline segment<T, 2> edge(const rectangle<T> &rectangle, const std::size_t &edge);
  template <typename T>
  inline segment<T, 2> edge(const polygon<T, 2> &polygon, const std::size_t &edge);
  template <typename T>
  inline segment<T, 3> edge(const polygon<T, 3> &polygon, const std::size_t &edge);
  ...
  template <typename T>
  inline point2d<T> centroid(const point2d<T> &point1, const point2d<T> &point2, const point2d<T> &point3, const point2d<T> &point4);
  template <typename T>
  ...
  template <typename T>
  inline bool common_center(const circle<T> &circle1, const circle<T> &circle2);
  template <typename T>
  inline bool common_center(const sphere<T> &sphere1, const sphere<T> &circle2);
  ...
  template <typename T>
  inline bool convex_vertex(const std::size_t &index, const polygon<T, 2> &polygon, const int &polygon_orientation = LeftHandSide);
  ...
  template <typename T>
  inline point3d<T> mirror(const point3d<T> &point, const plane<T, 3> &mirror_plane);
  template <typename T>
  inline segment<T, 3> mirror(const segment<T, 3> &segment, const plane<T, 3> &mirror_plane);
  template <typename T>
  inline line<T, 3> mirror(const line<T, 3> &line, const plane<T, 3> &mirror_plane);
  template <typename T>
  inline box<T, 3> mirror(const box<T, 3> &box, const plane<T, 3> &mirror_plane);
  template <typename T>
  inline triangle<T, 3> mirror(const triangle<T, 3> &triangle, const plane<T, 3> &mirror_plane);
  template <typename T>
  inline quadix<T, 3> mirror(const quadix<T, 3> &quadix, const plane<T, 3> &mirror_plane);
  template <typename T>
  inline sphere<T> mirror(const sphere<T> &sphere, const plane<T, 3> &mirror_plane);
  template <typename T>
  inline polygon<T, 3> mirror(const polygon<T, 3> &polygon, const plane<T, 3> &mirror_plane);
  ...
  template <typename T>
  inline circle<T> nonsymmetric_mirror(const sphere<T> &sphere, const T &ratio, const plane<T, 3> &plane);
  template <typename T>
  ...
  template <typename T>
  inline T lay_distance(const point2d<T> &point, const quadix<T, 2> &triangle);
  template <typename T>
  ...
  template <typename T>
  inline polygon<T, 2> minkowski_sum(const circle<T> &triangle, const circle<T> &circle);
  ...
  template <typename T>
  inline polygon<T, 2> minkowski_difference(const circle<T> &triangle, const circle<T> &circle);
  ...
  template <typename T>
  inline point2d<T> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const point2d<T> &point);
  template <typename T>
  inline point2d<T> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const point2d<T> &point, const point2d<T> &opoint);

  template <typename T>
  inline segment<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const segment<T, 2> &segment);
  template <typename T>
  inline segment<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const segment<T, 2> &segment, const point2d<T> &opoint);

  template <typename T>
  inline triangle<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const triangle<T, 2> &triangle);
  template <typename T>
  inline triangle<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const triangle<T, 2> &triangle, const point2d<T> &opoint);

  template <typename T>
  inline quadix<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const quadix<T, 2> &quadix);
  template <typename T>
  inline quadix<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const quadix<T, 2> &quadix, const point2d<T> &opoint);

  template <typename T>
  inline polygon<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const polygon<T, 2> &polygon);
  template <typename T>
  inline polygon<T, 2> fast_rotate(const trig_luts<T> &lut, const int rotation_angle, const polygon<T, 2> &polygon, const point2d<T> &opoint);
  ...
  template <typename T>
  inline point3d<T> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const point3d<T> &point);
  template <typename T>
  inline point3d<T> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const point3d<T> &point, const point3d<T> &opoint);

  template <typename T>
  inline segment<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const segment<T, 3> &segment);
  template <typename T>
  inline segment<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const segment<T, 3> &segment, const point3d<T> &opoint);

  template <typename T>
  inline triangle<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const triangle<T, 3> &triangle);
  template <typename T>
  inline triangle<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const triangle<T, 3> &triangle, const point3d<T> &opoint);

  template <typename T>
  inline quadix<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const quadix<T, 3> &quadix);
  template <typename T>
  inline quadix<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const quadix<T, 3> &quadix, const point3d<T> &opoint);

  template <typename T>
  inline polygon<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const polygon<T, 3> &polygon);
  template <typename T>
  inline polygon<T, 3> fast_rotate(const trig_luts<T> &lut, const int rx, const int ry, const int rz, const polygon<T, 3> &polygon, const point3d<T> &opoint);
  ...
  template <typename T>
  inline box<T, 3> aabb(const box<T, 3> &rectangle);
  template <typename T>
  ...
  template <typename T, typename OutputIterator>
  inline void generate_random_points(const T &x1, const T &y1, const T &x2, const T &y2, const std::size_t &point_count, OutputIterator out);
  template <typename T, typename OutputIterator>
  inline void generate_random_points(const T &x1, const T &y1, const T &z1, const T &x2, const T &y2, const T &z2, const std::size_t &point_count, OutputIterator out);
  template <typename T, typename OutputIterator>
  ...
  template <typename T>
  inline vector2d<T> operator*(const vector2d<T> &v1, const T &scale);
  template <typename T>
  inline vector3d<T> operator*(const vector3d<T> &v1, const T &scale);
  template <typename T>
  inline vector2d<T> operator*(const T &scale, const vector2d<T> &v1);
  template <typename T>
  inline vector3d<T> operator*(const T &scale, const vector3d<T> &v1);
  ...
  template <typename T>
  inline point3d<T> make_point(const point2d<T> point, const T &z = T(0.0));
  ...
  template <typename T>
  inline vector3d<T> make_vector(const vector2d<T> v, const T &z = T(0.0));
  ...
  template <typename T>
  inline plane<T, 3> make_plane(const point3d<T> &point1, const point3d<T> &point2, const point3d<T> &point3);
  template <typename T>
  inline plane<T, 3> make_plane(const point3d<T> &point, const vector3d<T> &normal);
  template <typename T>
  ...
  template <typename T>
  inline polygon<T, 2> make_polygon(const circle<T> &circle, const unsigned int point_count = 360);
