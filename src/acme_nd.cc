...
namespace acme
{
   ...
   template <typename T, std::size_t D>
   bool is_point_collinear(const segment<T,D>& segment, const pointnd<T,D>& point, const bool robust)
   {
   ...
   template <typename T, std::size_t D>
   bool intersect(const segment<T,D>& segment1, const segment<T,D>& segment2, const T& fuzzy)
   {
      return is_equal(distance(segment1,segment2),fuzzy);
   }

   template <typename T, std::size_t D>
   bool intersect(const line<T,D>& line1, const line<T,D>& line2, const T& fuzzy)
   {
      return is_equal(distance(line1,line2),fuzzy);
   }

   template <typename T, std::size_t D>
   pointnd<T,D> intersection_point(const segment<T,D>& segment1, const segment<T,D>& segment2, const T& fuzzy)
   {
   ...
   template <typename T, std::size_t D>
   pointnd<T,D> intersection_point(const line<T,D>& line1, const line<T,D>& line2, const T& fuzzy)
   {
   ...
   template <typename T, std::size_t D>
   pointnd<T,D> closest_point_on_line_from_point(const line<T,D>& line, const pointnd<T,D>& point)
   {
                                     ...
                                     const T& distance)
   {
      return project_point_t
             (
               source_point,
               destination_point,
               distance / acme::distance(source_point, destination_point)
             );
   }
   ...
   {
      acme::segment<T,D> _segment;

      for (std::size_t i = 0; i < acme::segment<T,D>::PointCount; ++i)
      {
   ...
   line<T,D> mirror(const line<T,D>& line, const acme::line<T,D>& mirror_axis)
   {
      ...
      for (std::size_t i = 0; i < acme::line<T,D>::PointCount; ++i)
      {
   ...
   box<T,D> mirror(const box<T,D>& box, const line<T,D>& mirror_axis)
   {
      ...
      for (std::size_t i = 0; i < acme::box<T,D>::PointCount; ++i)
      {
   ...
   {
      acme::triangle<T,D> _triangle;

      for (std::size_t i = 0; i < acme::triangle<T,D>::PointCount; ++i)
      {
   ...
   {
      acme::quadix<T,D> _quadix;

      for (std::size_t i = 0; i < acme::quadix<T,D>::PointCount; ++i)
      {
   ...
   {
      acme::pointnd<T,D> _point = closest_point_on_line_from_point(axis,point);
   ...
   segment<T,D> project_onto_axis(const triangle<T,D>& triangle, const line<T,D>& axis)
   {
      ...
      point_list.reserve(acme::triangle<T,D>::PointCount);
   ...
   segment<T,D> project_onto_axis(const box<T,D>& box, const line<T,D>& axis)
   {
      ...
      point_list.reserve(acme::box<T,D>::PointCount);
   ...
   segment<T,D> project_onto_axis(const quadix<T,D>& quadix, const line<T,D>& axis)
   {
      ...
      point_list.reserve(acme::quadix<T,D>::PointCount);
   ...
   template <typename T, std::size_t D>
   void generate_random_points(const box<T,D>& box, std::vector< pointnd<T,D> >& point_list)
   {
   ...
   template <typename T, std::size_t D>
   void generate_random_points(const segment<T,D>& segment, std::vector< pointnd<T,D> >& point_list)
   {
      for (std::size_t i = 0; i < point_list.size(); ++i)
      {
   ...
   template <typename T, std::size_t D>
   void generate_random_points(const triangle<T,D>& triangle, std::vector< pointnd<T,D> >& point_list)
   {
      for (std::size_t i = 0; i < point_list.size(); ++i)
      {
   ...
   template <typename T, std::size_t D>
   void generate_random_points(const quadix<T,D>& quadix, std::vector< pointnd<T,D> >& point_list)
   {
      for (std::size_t i = 0; i < point_list.size(); ++i)
      {
