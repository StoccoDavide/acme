...
namespace acme
{
      ...
      real_type tolerance)
  {
    ...
    case 202:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<vec3 const>(entity0),
    ...
    case 302:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<vec3 const>(entity1),
                                *std::dynamic_pointer_cast<line const>(entity0),
                                tolerance);
      break;

    case 303:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<line const>(entity0),
                                *std::dynamic_pointer_cast<line const>(entity1),
                                tolerance);
      break;
    ...
    case 403:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<line const>(entity1),
                                *std::dynamic_pointer_cast<ray const>(entity0),
                                tolerance);
      break;

    case 404:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<ray const>(entity0),
                                *std::dynamic_pointer_cast<ray const>(entity1),
                                tolerance);
      break;
    ...
    case 504:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<ray const>(entity1),
                                *std::dynamic_pointer_cast<plane const>(entity0),
                                tolerance);
      break;

    case 505:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<plane const>(entity0),
                                *std::dynamic_pointer_cast<plane const>(entity1),
                                tolerance);
      break;
    ...
    case 605:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<plane const>(entity1),
                                *std::dynamic_pointer_cast<segment const>(entity0),
                                tolerance);
      break;

    case 606:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<segment const>(entity0),
                                *std::dynamic_pointer_cast<segment const>(entity1),
                                tolerance);
      break;
    ...
    case 706:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<segment const>(entity1),
                                *std::dynamic_pointer_cast<triangle const>(entity0),
                                tolerance);
      break;

    case 707:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<triangle const>(entity0),
                                *std::dynamic_pointer_cast<triangle const>(entity1),
                                tolerance);
      break;
    ...
    case 807:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<triangle const>(entity1),
                                *std::dynamic_pointer_cast<circle const>(entity0),
                                tolerance);
      break;

    case 808:
      return acme::isOrthogonal(*std::dynamic_pointer_cast<circle const>(entity0),
                                *std::dynamic_pointer_cast<circle const>(entity1),
                                tolerance);
      break;
