...
int main()
{
  std::cout << "CGAL VS ACME: LINE-RAY" << std::endl
            << std::endl;
  ...
  for (unsigned int i = 0; i < n_samples; ++i)
  {
    ...
    Ray entity1_cgal(Point(p1x, p1y, p1z), Point(p2x, p2y, p2z));
    ...
    ray *entity1_acme = new ray(point(p1x, p1y, p1z), point(p2x, p2y, p2z));
