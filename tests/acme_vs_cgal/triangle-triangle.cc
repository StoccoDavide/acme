...
int main()
{
  std::cout << "CGAL VS ACME: TRIANGLE-TRIANGLE" << std::endl
            << std::endl;
  ...
  // Perform timing
  real p1x, p1y, p1z, p2x, p2y, p2z, p3x, p3y, p3z, p4x, p4y, p4z, p5x, p5y, p5z, p6x, p6y, p6z;
  for (unsigned int i = 0; i < n_samples; ++i)
  {
    ...
    Triangle entity2_cgal(Point(p4x, p4y, p4z), Point(p5x, p5y, p5z), Point(p6x, p6y, p6z));
    // Start chronometer
    tictoc_cgal.tic();
    ...
    triangle *entity2_acme = new triangle(point(p4x, p4y, p4z), point(p5x, p5y, p5z), point(p6x, p6y, p6z));
    // Start chronometer
    tictoc_acme.tic();
