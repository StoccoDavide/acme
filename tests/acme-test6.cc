...
int main()
{
  ...
  // Initialize segments
  line In1(point(0.0, 0.0, 0.5), vector(1.0, 0.0, 0.0));
  line In2(point(-2.0, 0.0, 0.5), vector(1.0, 0.0, 0.0));
  line Out(point(1.0, 2.0, 0.5), vector(1.0, 0.0, 0.0));
  line Tan(point(1.0, 1.0, 0.5), vector(1.0, 0.0, 0.0));
