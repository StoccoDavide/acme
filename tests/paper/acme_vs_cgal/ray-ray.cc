...
int main()
{
  std::cout << "CGAL VS ACME: RAY-RAY" << std::endl
            << std::endl;
  ...
  for (unsigned int i = 0; i < n_samples; ++i)
  {
    ...
    Ray entity2_cgal(Point(p3x, p3y, p3z), Point(p4x, p4y, p4z));
    // Start chronometer
    tictoc_cgal.tic();
    ...
    ray *entity2_acme = new ray(point(p3x, p3y, p3z), point(p4x, p4y, p4z));
    // Start chronometer
    tictoc_acme.tic();
