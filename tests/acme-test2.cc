...
int main()
{
  ...
  std::cout
      ...
      << "Segment Vertex 1\t= " << In1.vertex(1) << std::endl
      << "Intersection Vertex 0\t= " << IntIn1.vertex(0) << std::endl
      << "Intersection Vertex 1\t= " << IntIn1.vertex(1) << std::endl
      << std::endl
      << "Segment 2 with two intersections: bool(" << boolIn2 << ") intersection found" << std::endl
      << "Segment Vertex 0\t= " << In2.vertex(0) << std::endl
      << "Segment Vertex 1\t= " << In2.vertex(1) << std::endl
      << "Intersection Vertex 0\t= " << IntIn2.vertex(0) << std::endl
      << "Intersection Vertex 1\t= " << IntIn2.vertex(1) << std::endl
      << std::endl
      << "Segment with no intersections:  bool(" << boolOut << ") intersection found" << std::endl
      << "Segment Vertex 0\t= " << Out.vertex(0) << std::endl
      << "Segment Vertex 1\t= " << Out.vertex(1) << std::endl
      << "Intersection Vertex 0\t= " << IntOut.vertex(0) << std::endl
      << "Intersection Vertex 1\t= " << IntOut.vertex(1) << std::endl
      << std::endl
      << "Segment with one intersection:  bool(" << boolTan << ") intersection found" << std::endl
      << "Segment Vertex 0\t= " << Tan.vertex(0) << std::endl
      << "Segment Vertex 1\t= " << Tan.vertex(1) << std::endl
      << "Intersection Vertex 0\t= " << IntTan.vertex(0) << std::endl
      << "Intersection Vertex 1\t= " << IntTan.vertex(1) << std::endl
      << std::endl
