...
int main()
{
  ...
  // Initialize segments
  ray In1(point(0.0, 0.0, 0.5), vector(1.0, 0.0, 0.0));
  ray In2(point(-2.0, 0.0, 0.5), vector(1.0, 0.0, 0.0));
  ray Out(point(1.0, 2.0, 0.5), vector(1.0, 0.0, 0.0));
  ray Tan(point(1.0, 1.0, 0.5), vector(1.0, 0.0, 0.0));
