...
namespace acme
{
  ...
  public:
    ...
    //! Check whether in the collection there are any circle entity objects
    bool
    containCircle(void) const;

    //! Check whether the collection is composed only by circle entity objects
    bool
    areCircle(void) const;

    //! Check whether in the collection the i-th element is a circle entity object
    bool
    isCircle(
        size_t i //!< Input i-th value
    ) const;

    //! Remove all circle entity objects from collection
    void
    removeCircle(void);

    //! Count all circle entity objects in collection
    integer
    countCircle(void) const;
